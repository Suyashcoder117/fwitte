...
var hj = document.getElementById("user_name").innerHTML = "Welcome " + user_name + "!";

document.getElementById("user_name").innerHTML = hj;
...
function addRoom()
{
  ...
  firebase.database().ref("/").child(room_name).update({
    ...
    window.location = "fwitter_page.html";
}
